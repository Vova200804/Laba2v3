...
namespace Animal
{
  ...
  public static class Program
  {
    private static void Main()
    {
      ...
      AnimalManager.Instance.AddAnimal(new Bird("Aquila", 3, "Mountains", "Carnivore", 2.5));
      AnimalManager.Instance.AddAnimal(new Fish("Goldie", 1, "Aquarium", "Herbivore", "Fresh"));
      AnimalManager.Instance.AddAnimal(new Reptile("Slither", 2, "Desert", "Carnivore", true));
      AnimalManager.Instance.AddAnimal(new Amphibian("Jumpo", 1, "Pond", "Insectivore", "Moist"));
